function mostrar(){
	...
	with(document.forms[0]){
		if(document.getElementById("rdieta").value>0){
			x=document.forms[0].rdieta.value;	
			alert(x);
		}
	}
}
function añadirfila(tabla) {
    ...
    element3.name="cantidadalimento";
